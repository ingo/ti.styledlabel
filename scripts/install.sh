...
echo "titanium.platform=/Library/Application Support/Titanium/mobilesdk/osx/2.1.3.GA/android\n" >> build.properties
echo "android.platform=/Library/Application Support/Titanium/sdks/android-sdk-macosx/platforms/android-10\n" >> build.properties
